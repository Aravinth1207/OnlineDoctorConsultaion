...
class Appointment(models.Model):
    ...
    AppointmentPatient = models.ForeignKey(User,related_name="appointmentpatient",on_delete=models.CASCADE,default=None)
    ...
    def __str__(self):
        return f"{self.AppointmentPatient.username}'s Appointment"
